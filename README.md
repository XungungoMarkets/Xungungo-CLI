...
Download pre-compiled binary for your operating system from [v0.2.2 Release](https://github.com/XungungoMarkets/Xungungo-CLI/releases/tag/v0.2.2) page.

**Linux/macOS:**
```bash
# Download file
wget https://github.com/XungungoMarkets/Xungungo-CLI/releases/download/v0.2.2/xgg-linux-amd64.tar.gz
...
```bash
# Download
wget https://github.com/XungungoMarkets/Xungungo-CLI/releases/download/v0.2.2/xgg-darwin-arm64.tar.gz
...
```powershell
# Download file
# https://github.com/XungungoMarkets/Xungungo-CLI/releases/download/v0.2.2/xgg-windows-amd64.zip
...
**Output:**
```
✓ You are using the latest version: 0.2.2
```
...
⚠ A new version is available!
  Current: 0.2.2
  Latest: 0.2.3
  Release:  https://github.com/XungungoMarkets/Xungungo-CLI/releases/download/v0.2.3/xgg-linux-amd64.tar.gz
